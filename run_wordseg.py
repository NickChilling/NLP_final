...
flags.DEFINE_string('mode', 'test', 'running mode: "train", "evaluate" or "all"')
...
flags.DEFINE_string('raw_test2_data_path', r'./test2.txt', 'path to raw_test2_data')
flags.DEFINE_string('test2_data_path', r'./test2_data', 'path to test2')
