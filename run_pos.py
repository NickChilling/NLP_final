...
flags.DEFINE_string('raw_test2_data_path', r'./data/testset1/test_pos1.txt', 'path of the raw test1 data')
...
flags.DEFINE_string('test2_data_path', r'./data/pos/test1_data', 'path of the processed test1 data')
